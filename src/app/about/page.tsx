...
export const metadata: Metadata = {
  title: "About Dead Rails Wiki & Network Standards",
  description: "Learn about the Dead Rails fan wiki, our editorial testing process, and the Roblox Wiki Hub network.",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <main className="min-h-[75vh] py-12 px-4 sm:px-6 max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
          About Dead Rails Wiki
        </h1>
        <p className="text-sm text-slate-300 mt-2 leading-relaxed">
          Independent player guide, probability calculators, and working redeem codes for Dead Rails.
        </p>
      </div>
